const fs = require('fs');
let code = fs.readFileSync('src/components/views/TrackingView.jsx', 'utf8');
...
fs.writeFileSync('src/components/views/TrackingView.jsx', code, 'utf8');
console.log("Patched TrackingView");
