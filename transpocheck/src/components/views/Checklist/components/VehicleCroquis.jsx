...
export const VehicleCroquis = ({ handlePhotoClick }) => {
  ...
  return (
    <div className="bg-slate-50 dark:bg-slate-900 p-4 rounded-3xl border-2 border-slate-100 dark:border-slate-800 mb-4 select-none relative shadow-sm">
      ...
      <div className="relative w-[160px] sm:w-[200px] h-[400px] mx-auto my-16">
        <div
          ...
          {!formData.zoomZone && (
            <>
              ...
              <button type="button" onClick={(e) => { e.stopPropagation(); handlePhotoClick('left', 'LATERAL PILOTO'); }} 
                className={`absolute top-1/2 -left-16 sm:-left-24 -translate-y-1/2 w-16 h-16 sm:w-20 sm:h-20 rounded-full border-4 flex flex-col items-center justify-center cursor-pointer shadow-lg overflow-hidden bg-white dark:bg-slate-900 transition-all z-20 hover:scale-105 active:scale-95 ${formData.photos.left ? 'border-green-400 ring-4 ring-green-100/50' : 'border-dashed border-slate-300 dark:border-slate-600 hover:bg-slate-50 dark:hover:bg-slate-800'}`}>
              ...
              <button type="button" onClick={(e) => { e.stopPropagation(); handlePhotoClick('right', 'LATERAL COPILOTO'); }} 
                className={`absolute top-1/2 -right-16 sm:-right-24 -translate-y-1/2 w-16 h-16 sm:w-20 sm:h-20 rounded-full border-4 flex flex-col items-center justify-center cursor-pointer shadow-lg overflow-hidden bg-white dark:bg-slate-900 transition-all z-20 hover:scale-105 active:scale-95 ${formData.photos.right ? 'border-green-400 ring-4 ring-green-100/50' : 'border-dashed border-slate-300 dark:border-slate-600 hover:bg-slate-50 dark:hover:bg-slate-800'}`}>
