      ...
      {!formData.noReception && (
        <div className="bg-white dark:bg-slate-900 p-5 rounded-3xl border border-slate-200/60 dark:border-slate-800/60 shadow-sm space-y-4">
          ...
          {!formData.signatureLocked ? (
            ...
            <div className="bg-green-50/50 dark:bg-green-900/10 p-5 rounded-3xl border border-green-200/50 dark:border-green-800/30 shadow-sm text-center relative overflow-hidden animate-in zoom-in-95 mt-4">
