        ...
        <div className="grid md:grid-cols-2 gap-6 w-full min-w-0 animate-in fade-in">
          <form key={editingToll ? editingToll.id : 'new-toll'} onSubmit={async (e) => {
             ...
             const data = {
                ...
                prices: {
                   'Moto': Number(fd.get('priceMoto')) || 0,
                   'Auto / SUV': Number(fd.get('priceAuto')) || 0,
                   'Camioneta': Number(fd.get('priceCamioneta')) || 0,
                   'Furgón': Number(fd.get('priceFurgon')) || 0,
                   'Bus': Number(fd.get('priceBus')) || 0,
                   'Camión 2 Ejes': Number(fd.get('priceCamion2Ejes')) || 0,
                   'Camión 3+ Ejes': Number(fd.get('priceCamion3Ejes')) || 0
                }
             };
             ...
             <div className="grid grid-cols-2 gap-3 bg-emerald-50 p-3 rounded-2xl border border-emerald-100">
                ...
                <div className="space-y-1">
                   <label className="text-[10px] font-bold text-slate-600 ml-1">Moto ($)</label>
                   <input name="priceMoto" type="number" defaultValue={editingToll?.prices?.['Moto']} placeholder="0" required className="w-full border border-emerald-200 p-2 rounded-lg text-sm outline-none focus:border-emerald-500 font-bold bg-white"/>
                </div>
                <div className="space-y-1">
                ...
                <div className="space-y-1">
                   <label className="text-[10px] font-bold text-slate-600 ml-1">Furgón ($)</label>
                   <input name="priceFurgon" type="number" defaultValue={editingToll?.prices?.['Furgón']} placeholder="0" required className="w-full border border-emerald-200 p-2 rounded-lg text-sm outline-none focus:border-emerald-500 font-bold bg-white"/>
                </div>
                <div className="space-y-1">
                   <label className="text-[10px] font-bold text-slate-600 ml-1">Bus ($)</label>
                   <input name="priceBus" type="number" defaultValue={editingToll?.prices?.['Bus']} placeholder="0" required className="w-full border border-emerald-200 p-2 rounded-lg text-sm outline-none focus:border-emerald-500 font-bold bg-white"/>
                </div>
                <div className="space-y-1">
                   <label className="text-[10px] font-bold text-slate-600 ml-1">Camión 2 Ejes ($)</label>
                   <input name="priceCamion2Ejes" type="number" defaultValue={editingToll?.prices?.['Camión 2 Ejes']} placeholder="0" required className="w-full border border-emerald-200 p-2 rounded-lg text-sm outline-none focus:border-emerald-500 font-bold bg-white"/>
                </div>
                <div className="col-span-2 space-y-1">
                   <label className="text-[10px] font-bold text-slate-600 ml-1">Camión 3+ Ejes ($)</label>
                   <input name="priceCamion3Ejes" type="number" defaultValue={editingToll?.prices?.['Camión 3+ Ejes']} placeholder="0" required className="w-full border border-emerald-200 p-2 rounded-lg text-sm outline-none focus:border-emerald-500 font-bold bg-white"/>
                </div>
             </div>
                 ...
                 <div key={t.id} className="flex justify-between items-center p-3 bg-slate-50 border border-slate-100 rounded-xl hover:border-emerald-200 transition-all group">
                   <div className="flex-1 min-w-0 pr-2">
                     ...
                     <div className="flex gap-1.5 mt-1.5 flex-wrap">
                        <span className="text-[9px] font-bold bg-white border border-slate-200 text-slate-600 px-1.5 py-0.5 rounded">🏍️ Moto: ${t.prices?.['Moto'] || 0}</span>
                        ...
                        <span className="text-[9px] font-bold bg-white border border-slate-200 text-slate-600 px-1.5 py-0.5 rounded">🚐 Furgón: ${t.prices?.['Furgón'] || 0}</span>
                        <span className="text-[9px] font-bold bg-white border border-slate-200 text-slate-600 px-1.5 py-0.5 rounded">🚌 Bus: ${t.prices?.['Bus'] || 0}</span>
                        <span className="text-[9px] font-bold bg-white border border-slate-200 text-slate-600 px-1.5 py-0.5 rounded">🚛 Camión 2E: ${t.prices?.['Camión 2 Ejes'] || 0}</span>
                        <span className="text-[9px] font-bold bg-white border border-slate-200 text-slate-600 px-1.5 py-0.5 rounded">🚛 Camión 3+E: ${t.prices?.['Camión 3+ Ejes'] || 0}</span>
                     </div>
                   </div>
                   <div className="flex flex-col gap-1.5 shrink-0 ml-2">
